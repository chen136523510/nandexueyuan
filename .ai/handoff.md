...
> 最新提交：`eb4e00a`（已拉取，黑机本轮 19 个提交均未部署）
> **当前阶段**：
> - P5 美术：立绘 + 像素精灵 + 场景瓦片 + 三层塔楼改造 **全部完成**
> - P2 NPC AI 对话：**白机 07-20 下午优化完成**（广播 @ 提问者 + 身份感知 + 花名册注入）
...
- [ ] **部署到生产**：本轮改动（NPC 广播 @ + 身份感知 + 花名册），待用户确认后执行 `bash deploy.sh`
