...
#### 验证与下一步
- ✅ `npm run build` 通过
- ⏳ 浏览器人工验证待院长过目（本会话按院长指示未开浏览器/未截图）：建议起 dev 后桌面+手机各过一遍（主题切换 / 排行头像 / 打字机 / 公告红点 / 底部导航 / 首页视差）
- ⏳ 未 commit（待院长确认后提交 [feat](德塔): 门户趣味化）
- ⏳ 未发版、未部署
