...
### ① R-053 RAG 检索增强方案 B/C/D 实施完成（代码已落地，待部署）
...
- **部署待办**：git pull + deploy.sh 全流程；线上需实测"群里讨论考研的频率高吗"等话题检索问题确认 rerank 过程提示和块覆盖准确性
- **commit**：本轮
