...
> 最后更新：2026-08-20 15:25（白机本轮：**v3.5.0 发版部署上线 男德通多模态一期·图片理解**（功能 commit 82d2e33 + gitignore b7ce794 + 文档 ec1a500 + 发版 8602b91。**已部署上线**：prod.db ALTER TABLE images + uploads/chat 目录 + deploy.sh 9步 + Nginx /root 权限修复（服务器重启后 /root 权限回退致前端 500，chmod o+x /root 修复）+ 线上公告 v3.5.0 + 浏览器实测上传图全链路通过。同日上午产出 Qwen3.8-27B 调研：视频/图片输出系误传，落档 00-调研/，commit e81e331））
