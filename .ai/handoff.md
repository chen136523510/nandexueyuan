...
- [ ] 第一幕台词已定稿 → 白机写代码落地（骨架+文案）
- [ ] 第二幕/第三幕/第四幕台词逐句过（白机）

**美术需求（黑机出图，按优先级）**：
- [ ] ⛰️ downhill 帝桥哨卡场景（哨卡+大河右→左+对岸望不到头+大桥横跨）P1
- [ ] ⛰️ downhill 清晨草原无人版（tower_outdoor_mist 去人物，幕间结尾用）P1
- [ ] ⛰️ downhill 见场景B新立绘（端杯姿态基准+严肃差分，幕间场景B+第二幕复盘用）P1
- [ ] ⛰️ downhill 幸谈判态基准+deal+warning差分（第二幕重头戏）P1
- [ ] 恪形象设计+立绘（第一幕，P1）
- [ ] 班走廊月亮CG重做 CG-1 + 新增 CG-2（黑机优先项）
- [ ] 第一幕出发·草原路（添带路）P2
- [ ] 草原村口背景（官员身后站魔法师）P2
