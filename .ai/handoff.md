...
**班CG重做（黑机优先，下次会话）**：
- [ ] ⛰️ downhill CG-1 重做：班坐走廊尽头窗边床沿看月亮（保留楼梯），覆盖 `ban_corridor_moon.png`
- [ ] ⛰️ downhill CG-2 新增：班近景特写（坐椅子靠床边，眼神忧郁，月光洒脸），输出 `ban_closeup_moon.png`
