...
> 最后更新：2026-08-03 23:44（白机：第一章编剧评审+美术资产清理+班形象设计/脸模+SKILL流程补充+全量记录下机）
> 所在设备：白机（荣耀便携本）
> 稳定版本：v2.4.0 已部署上线（commit `811410d`）；最新文档 commit `37b5f4d`（班形象+美术清理+SKILL，已推送）
...
- [ ] 科夫（帝国军官）/西娜（海盗头子）形象设计（第一章另两个新 NPC）
