...
> 最后更新：2026-08-19 15:40（白机本轮：**R-043 学院数据部署修复 BUG-70**（module_visits 建表建到 dev.db 而非 prod.db 致埋点 API 500，对 prod.db 建表+重启 PM2 修复+文档修正）。服务器 IP 以 `docs/account-passwords.md` 为准：47.96.158.104）
