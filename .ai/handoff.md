...
- [ ] 信使立绘（死灵傀儡，不露正脸）P2——与饶形象设计同批讨论出图，出图前无立绘兜底
- [ ] 出发·草原路 P2 / 幸谈判态差分 P2 可选 / 第三幕三张事变画像已改照片 P2
