...
> 最后更新：2026-08-20 10:49（白机本轮：**Qwen3.8-27B 调研**（院长核实"能输出视频图片/2张4090部署"传闻，结论：模型真实存在 2026-08-14 发布但**只能理解不能生成**图视频，"出视频"系误传；4bit 量化单卡 4090 即可跑；真正 4090 能出视频的是 Wan2.2-TI2V-5B。建议不为此租 GPU，落档 `prd/01-需求文档/00-调研/Qwen3.8-27B调研与自部署可行性.md`，commit 7fe1218））
> 所在设备：白机（判定依据：周四 10:49 工作日白天时段）
