...
> 最后更新：2026-08-06 10:30（白机：第二幕落地+文档同步，今日收工交接）
> 所在设备：白机
> 稳定版本：v2.4.0 已部署上线（commit `811410d`）；最新代码 commit `f1f619a`（第二幕代码落地）
...
**美术需求（黑机出图，按优先级）**：
- [ ] ⛰️ downhill **谈判全景 ×3**（对峙/幸看玩家/见看玩家：圆桌+幸左见右+添坐+班靠墙+羊皮卷发光，玩家视角）P1
- [ ] ⛰️ downhill **合同羊皮卷道具图**（有字+魔法印记）P1
...
- [ ] 幸谈判态/deal/warning 差分 → 降级 P2 可选（谈判段已用全景图，留待幸再访章节）
- [ ] 第三幕三张共和国事变画像 P2
