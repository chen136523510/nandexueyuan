...
> 关联文档：`../02-工具与AI服务/视频生成API调研.md`、`../02-工具与AI服务/MiniMax视频生成API使用指南.md`、`提示词工程调研-图片与视频生成.md`
...
对照项目现用渠道（详见 `../02-工具与AI服务/视频生成API调研.md`：MiniMax 官方 H3 API 768P 0.5 元/秒、2K 0.8 元/秒；Seedance 30 秒 53 元 ≈ 1.77 元/秒），AutoDL 托管价 **0.04 元/秒比官方 API 便宜一个数量级**（30 秒视频约 1.2 元 vs Seedance 53 元）。若后续 CG 视频量产，此渠道值得单独调研验证（画质/时长限制/角色一致性待确认）。
