...
import { updateProfile, updateSkin, updatePassword, avatarUpload } from '../controllers/userController.js'
...
// 用户相关（需登录）
router.put('/user/profile', auth, avatarUpload.single('avatar'), updateProfile)
...
router.get('/chat/db-info', auth, getDbInfo)
