...
const versionList = [
  {
    ...
    summary: '德塔空间探索机制上线：第一章第三幕「东来的信」落地',
    updates: JSON.stringify([
      '新增空间探索机制：自由活动时可在塔楼各地点走动（大厅/走廊/房间），存档保留所在位置',
      '第一章第三幕「东来的信」上线：共和国事变传闻+神秘信使（丘的信伏笔道具）',
      '第二幕结尾改为自由探索：幸走后可与见/添/班聊天，看月亮、回房休息',
      '新增美术资产：谈判全景×3、恪立绘、帝国军装设计稿、草原村口/回程/幸造访背景、合同羊皮卷、睿帝令',
      '世界观补充：帝国记忆碎片传讯、共和国照片科技、沙漠附庸史、饶死灵傀儡信使',
      '修复第二幕收尾场景切换时机：幸离场后才恢复立绘与大厅实景',
    ], null, 0),
