...
const versionList = [
  ...
  },
  {
    ...
    updates: JSON.stringify([
      '发图秒懂——现在直接让大模型看图，不再依赖识别子模型（兼容性更好，未来换模型也不怕）',
      '群聊话题问答更准——搜索结果排序更合理，敏感话题也能找到相关聊天',
      '偶尔网络抖动也能救回——检索请求会自动重试，不会动不动就降级',
      '群聊搜索更稳——含点号的昵称（如 O.o / @.........）现在能正常搜到',
      '手机端发图、刷留言更顺——修复了页面被底栏挡住的小问题',
    ], null, 0),
    plans: JSON.stringify([
      '数据考古——从 53 万条群聊里挖金子（编年史、人物卡、峰值日考古等）',
      'TODO 待补充',
    ], null, 0),
  },
  {
